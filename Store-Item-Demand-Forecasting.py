...
# En iyi parametrelerin bunlar olduğu söylendiği için hiperparametre optimizasyonu yapılmamıştır.
...
smape(np.expm1(y_pred_val), np.expm1(Y_val)) # 13.558439029330057
...
# Kaggle Private Score: 12.88170
# Kaggle Public Score : 14.15484
